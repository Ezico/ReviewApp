...
const Header = ({ active, user }) => {
  ...
  return (
    <>
      {menu}
      <header id="navbr" className="black navbarx">
        <div className="wrapper-x">
          <div className="row s-e">
            ...
            <div className="col-6 hide-small">
              <div className="search">
                <form action={`/search?value`}>
                  <input type="text" className="search_field" />
                  <button type="submit" className="search_icon">
            ...
            <div className="col-2">
              {user ? (
                <div className="userbal hide-small">
                  <UserIcon />
                  <div className="user-info">
                    <div className="user">{user.userName}</div>
                    <div className="user-balance">
                      <span style={{ color: "black" }}>Bal:</span> ₦
                      {user.balance}
                    </div>
                  </div>
                </div>
